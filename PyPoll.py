...
# issues with file directory, though file is in 'election-analysis' folder, needed to be provided after no longer working the next day without
file_to_load = os.path.join("election-analysis", "Resources", "election_results.csv")
# Assign a variable to save the file to a path.
file_to_save = os.path.join("election-analysis", "analysis", "election-analysis.txt")
